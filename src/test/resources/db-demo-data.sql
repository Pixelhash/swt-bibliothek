...
INSERT INTO `benutzer` (`id`, `vorname`, `nachname`, `rolle`, `telefonnummer`, `email`, `geburtsdatum`, `passwort`, `activation_token`, `password_reset_token`, `adresse_id`) VALUES (1, 'Peter', 'Meyer', 'MITARBEITER', '0123456789', 'peter.meyer@gmail.com', '1979-01-10', '$2a$10$VeGuPer4REsqJABd7DwYyeP6oB1Ft7LpzkBHbTDy.CSNxwctriKuy', NULL, NULL, 2);
INSERT INTO `benutzer` (`id`, `vorname`, `nachname`, `rolle`, `telefonnummer`, `email`, `geburtsdatum`, `passwort`, `activation_token`, `password_reset_token`, `adresse_id`) VALUES (2, 'Anna', 'Kubinzki', 'KUNDE', '0987654321', 'anna.kubinzki@web.de', '1987-07-24', '$2a$10$bJQMIcO4ldf5xwuNK/Rtx.2z1bsXHH5V0UNOtDvNm0i.iigVSRh16', NULL, NULL, 1);
INSERT INTO `benutzer` (`id`, `vorname`, `nachname`, `rolle`, `telefonnummer`, `email`, `geburtsdatum`, `passwort`, `activation_token`, `password_reset_token`, `adresse_id`) VALUES (3, 'Klaus-Dieter', 'Wottramm', 'KUNDE', '01928173645', 'klaus-dieter.wottramm@gmx.de', '1958-04-16', '$2a$10$MHq0aXFeXFXsu7wYlRavTOarqkZ4T/7DlXbk4S1RC.m17MTER2hue', NULL, NULL, 3);
